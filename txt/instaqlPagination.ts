...
// account (bucket.ts's resolveOwnedDocuments, updateDbCatalog.ts's and
// updateDbPrefixHash.ts's own fetchTxtRows are current callers). Kept
// backend/shape-agnostic on purpose: the caller
