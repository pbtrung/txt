...
export function ProgressStatus({ progress, fallbackLabel, spinnerClassName }: ProgressStatusProps) {
  return (
    <>
      <div
      ...
      <div className="small text-body-secondary">{progress?.label ?? fallbackLabel}…</div>
    </>
  );
}
