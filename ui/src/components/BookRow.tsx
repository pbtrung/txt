...
// renders a trailing "x" (also just Continue Reading). Also reused by the
// admin Manage screen's Books section, where `selected` highlights the
// row picked for its Edit/Delete toolbar instead of navigating anywhere.
...
// renders BookRow (Library's Continue Reading/All books/browse-value,
// Manage's Books) so they all agree on one source of truth.
...
export function BookRow({ book, onClick, onDelete, hidePartNum, selected, style }: BookRowProps) {
