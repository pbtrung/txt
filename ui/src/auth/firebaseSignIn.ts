...
// needs the idToken itself (to call the Worker's /v1/db-token), which the
...
export async function signIn(apiKey: string, email: string, password: string): Promise<FirebaseSession> {
