...
export function toBookInfo(txtId: number, name: string, metadata: OpfMetadata): BookInfo {
  return {
    txtId,
    name,
...
export async function parseMetadataBlob(compressed: Uint8Array | null): Promise<OpfMetadata> {
