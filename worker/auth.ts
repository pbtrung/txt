...
// Firebase ID token for this project" and nothing else -- dbToken.ts and
...
export async function verifiedUid(request: Request, projectId: string): Promise<string | null> {
